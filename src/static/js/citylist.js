...
export default {
     ...
     *  返回二级联动的value
     */
    getValueByLabel(province,city){
        let value=[];
        this.getTwoArea().forEach((e)=>{
            if(e.label==province){
              value.push(e.value)
